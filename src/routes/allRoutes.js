...
export const allRoutes = [
    ...
    new Route("/connexion", "Connexion", "./src/pages/auth/signin.html", "./src/js/auth/signin.js"),
    new Route("/inscription", "Inscription", "./src/pages/auth/signup.html", "./src/js/auth/signup.js"),
    new Route("/contacts", "Contacts", "./src/pages/contacts.html"),
    new Route("/mon-compte", "Mon compte", "./src/pages/mon-compte.html"),
